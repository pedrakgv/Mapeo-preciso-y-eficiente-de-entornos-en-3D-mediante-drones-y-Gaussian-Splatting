...
class Mavic (Robot):
    ...
    def run(self):
        ...
        # print("Posicion: "+str(self.current_pose))
        ...
        waypoints = [  [166,164], [131,153], [99,153], [54,139], [25,130], [166,174]]
        ...
        while self.step(self.time_step) != -1:
            ...
            if tiempo_actual - tiempo_inicial >= intervalo_tiempo:            
                self.camera.saveImage("Imagenes/imagen-"+str(self.contador)+".jpeg",100)
